...
crossover :: Double -> [(Double, Double)] -> Double -> [BSpline U.Vector Double]
crossover lo transitions hi = [band (x-wX/2) (x+wX/2) (y-wY/2) (y+wY/2) | ((x, wX),(y, wY)) <- zip ((lo, 0) : transitions) (transitions ++ [(hi,0)])]
